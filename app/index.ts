...
const tree = JSON.parse(fs.readFileSync('app/tree-data/my-tree.json', 'utf-8'));
...
fs.writeFileSync('app/tree-data/my-tree-sum.json', JSON.stringify(tree, null, 2), 'utf-8');
